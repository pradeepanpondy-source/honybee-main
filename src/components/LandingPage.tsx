    ...
    <div className="min-h-screen bg-honeybee-background flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6 md:p-8 text-center">
        <motion.div
          initial="initial"
          animate="animate"
          className="text-3xl md:text-4xl font-serif font-black text-honeybee-secondary mb-6 flex justify-center items-center"
        >
          ...
          <motion.span
            ...
            className="text-honeybee-primary ml-1.5"
          >
            Bridge
          </motion.span>
        </motion.div>
