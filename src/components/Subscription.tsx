      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="group">
          <div className="bg-white rounded-lg shadow-lg animate-card-hover p-6 text-center">
            ...
            <div className="group">
              <button className="bg-purple-600 text-white px-8 py-3 rounded-md animate-button-hover">Choose Plan</button>
            </div>
          </div>
        </div>
        ...
        {/* Plan 2 */}
        <div className="group">
          <div className="bg-white rounded-lg shadow-lg animate-card-hover p-6 text-center border-2 border-purple-500">
        ...
        <div className="group">
          <div className="bg-white rounded-lg shadow-lg animate-card-hover p-6 text-center">
            ...
            <p className="text-4xl font-bold text-purple-600 mb-4">₹1299</p>
            <ul className="text-left space-y-2 mb-6 text-gray-600">
