  ...
  return (
    <nav className="px-4 py-3">
      <div className="flex items-center justify-between max-w-6xl mx-auto">
        <h1 className="text-2xl font-bold text-white">Honey Bridge</h1>
          ...
          <div className="relative">
            <div className="group">
              <ClickEffect
                ...
                className="p-2 text-white rounded-lg animate-button-hover"
              >
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white/10 backdrop-blur-lg rounded-lg shadow-lg py-1 z-20 border border-purple-300">
                <div className="group">
                  <button 
                    ...
                    className="w-full text-left px-4 py-2 text-sm text-white animate-button-hover flex items-center"
                  >
