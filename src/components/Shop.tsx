      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {products.map((product) => (
          <div key={product.id} className="group">
            <div className="bg-white rounded-lg shadow-lg animate-card-hover overflow-hidden">
              <img
                src={product.image}
                alt={product.name}
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <div className="group">
                    <button className="bg-purple-600 text-white px-3 py-1 rounded-md animate-button-hover flex items-center">
